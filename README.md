...
- [Phony](https://codeberg.org/everyname/phony) - Phony is a Fluxer bot that creates "phony channels", voice channels which disappear when everyone leaves. [Add the Phony bot to your Fluxer community](https://web.fluxer.app/oauth2/authorize?client_id=1505390819898610586&scope=bot&permissions=4503599627373584).
